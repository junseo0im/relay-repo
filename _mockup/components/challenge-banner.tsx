        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white mb-1">2026 새해 첫 이야기 챌린지</h3>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                ...
                {[
                  ...
                  <div key={item.label} className="text-center">
                    <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-2 min-w-[48px] border border-white/10 transition-all hover:bg-white/30 hover:scale-105">
                      <span className="text-xl font-bold tabular-nums">{String(item.value).padStart(2, '0')}</span>
                    </div>
            ...
            <Link href="/challenges">
              <Button variant="secondary" className="bg-white text-primary hover:bg-white/90 shadow-lg hover:shadow-xl transition-all hover:scale-105">
                챌린지 스토리 보기
              </Button>
            </Link>
          </div>
