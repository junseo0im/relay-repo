      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6 text-balance animate-in fade-in slide-in-from-bottom duration-700 delay-100">
            함께 이야기를
            <br />
            <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">완성해보세요</span>
          </h1>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-4xl mx-auto">
          {[
            ...
            >
              <div className="text-2xl md:text-3xl font-bold bg-gradient-to-br from-foreground to-foreground/70 bg-clip-text text-transparent group-hover:from-primary group-hover:to-secondary transition-all duration-300">{stat.value}</div>
